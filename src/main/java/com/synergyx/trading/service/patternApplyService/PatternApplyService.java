...
public interface PatternApplyService {
    // 패턴 적용
    PatternApplyResponseDTO.PatternApplyResultDTO applyPattern(PatternApplyRequestDTO.PatternApplyDTO request);

    // 패턴 알림 토글
    PatternApplyResponseDTO.PatternApplyResultDTO toggleNotification(Long patternApplyId);
}
